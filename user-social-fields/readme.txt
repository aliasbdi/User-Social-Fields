...
1. Upload `bdi-user-social-fields` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Place `<?php do_shortcode('[userfields]'); ?>` in your templates or `[userfields]`

== Frequently Asked Questions ==

= How do I set the user? =

In the shortcode, add the attribute "user" with a value of either the user's id or login (example: [userfields user="jabshire"]).
